...
class Bang extends Table with TableInfo<Bang, BangData> {
  ...
  late final GeneratedColumn<String> snapDomain = GeneratedColumn<String>(
    'snap_domain',
    aliasedName,
    true,
    type: DriftSqlType.string,
...
class BangData extends DataClass implements Insertable<BangData> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || snapDomain != null) {
      map['snap_domain'] = Variable<String>(snapDomain);
    }
    return map;
  }
  ...
  factory BangData.fromJson(
    ...
    return BangData(
      ...
      snapDomain: serializer.fromJson<String?>(json['snapDomain']),
    );
  }
  @override
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'snapDomain': serializer.toJson<String?>(snapDomain),
    };
  }
  ...
  BangData copyWith({
    ...
    int? searxngApi,
    Value<String?> snapDomain = const Value.absent(),
  }) => BangData(
    ...
    snapDomain: snapDomain.present ? snapDomain.value : this.snapDomain,
  );
  BangData copyWithCompanion(BangCompanion data) {
    return BangData(
      ...
      searxngApi: data.searxngApi.present
          ...
          : this.searxngApi,
      snapDomain: data.snapDomain.present
          ? data.snapDomain.value
          : this.snapDomain,
    );
  }
  ...
  bool operator ==(Object other) =>
      ...
      (other is BangData &&
          ...
          other.snapDomain == this.snapDomain);
}
...
class BangCompanion extends UpdateCompanion<BangData> {
  ...
  const BangCompanion({
    ...
    this.snapDomain = const Value.absent(),
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (snapDomain.present) {
      map['snap_domain'] = Variable<String>(snapDomain.value);
    }
    if (rowid.present) {
