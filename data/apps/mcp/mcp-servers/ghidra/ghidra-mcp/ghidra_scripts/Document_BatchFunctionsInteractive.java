// Batch Functions Interactive
//
// Interactive version of BatchFunctions with configuration prompts before processing. Allows setting max functions, filtering criteria, and output preferences before the scan begins.
//
// Usage: Run from Script Manager via Ctrl+Shift+I. Prompts for configuration.
...
public class Document_BatchFunctionsInteractive extends GhidraScript {
