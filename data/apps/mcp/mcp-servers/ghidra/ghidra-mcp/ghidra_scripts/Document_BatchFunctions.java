// Batch Functions
//
// Iterates through all functions, validates completeness (plate comment, signature, variables, globals), and generates a prioritized list of undocumented functions for Claude-assisted RE.
//
// Usage: Run from Script Manager via Ctrl+Shift+B.
...
public class Document_BatchFunctions extends GhidraScript {
