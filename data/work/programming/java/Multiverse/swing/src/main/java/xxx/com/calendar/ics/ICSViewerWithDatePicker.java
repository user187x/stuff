...
//
//public class ICSViewerWithDatePicker extends JFrame {
//
...
//
//    northPanel.add(new JLabel("Seek to Date:"));
//
...
//    dateButton.addActionListener(e -> datePicker.showPopup());
...
//    timeEditor.setPreferredSize(new Dimension(80, 25));
//    JButton timeButton = new JButton("🕒");
//    timeButton.setPreferredSize(new Dimension(25, 25));
//    timeButton.addActionListener(e -> timePicker.showPopup());
//    JPanel timePanel = new JPanel(new FlowLayout(FlowLayout.LEFT, 0, 0));
//    timePanel.add(timeEditor);
//    timePanel.add(timeButton);
//    northPanel.add(timePanel);
//
//    JButton dateSeekButton = new JButton("Go");
//    dateSeekButton.addActionListener(e -> performDateSeek(datePicker, timePicker));
//    northPanel.add(dateSeekButton);
//
...
//  }
//
//  private void performDateSeek(DatePicker datePicker, TimePicker timePicker) {
//    LocalDate ld = datePicker.getSelectedDate();
//    LocalTime lt = timePicker.getSelectedTime();
//    if (ld == null || lt == null) return;
...
//        synchronized (dbLock) {
//          try (PreparedStatement ps = dbConnection.prepareStatement("SELECT MIN(id) FROM records WHERE start_time >= ?")) {
//            ps.setLong(1, millis);
...
//            }
//          } else {
//            JOptionPane.showMessageDialog(ICSViewer.this, "No events found on or after the selected date.");
//          }
//        } catch (Exception e) {
//          e.printStackTrace();
//        }
...
//
//        Long newStartTime = parseStartTime(newContent);
//
//        synchronized (dbLock) {
//          try (PreparedStatement ps = dbConnection.prepareStatement("UPDATE records SET content = ?, start_time = ? WHERE id = ?")) {
...
//  }
//
//  private Long parseStartTime(String content) {
//    if (content == null) return null;
//    for (String line : content.split("\r?\n")) {
//      if (line.startsWith("DTSTART")) {
//        try {
//          int colonIndex = line.indexOf(':');
//          String prop = line.substring(0, colonIndex);
//          String value = line.substring(colonIndex + 1).trim();
//
//          boolean isDateOnly = prop.contains("VALUE=DATE");
//
//          String tzid = null;
...
//            stmt.execute("CREATE TABLE IF NOT EXISTS records (id INT PRIMARY KEY, content TEXT, start_time BIGINT)");
...
//              }
//              inEvent = false;
//            } else if (inEvent && eventBuilder != null) {
...
//        String sql = "INSERT INTO records (id, content, start_time) VALUES (?, ?, ?)";
//        try (PreparedStatement ps = dbConnection.prepareStatement(sql)) {
//          for (int i = 0; i < allEvents.size(); i++) {
//            ps.setInt(1, i + 1);
//            ps.setString(2, allEvents.get(i));
//            ps.setObject(3, parseStartTime(allEvents.get(i)));
//            ps.addBatch();
