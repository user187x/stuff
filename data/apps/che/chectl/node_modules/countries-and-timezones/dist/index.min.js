(function(a, i) {
	"object" == typeof exports && "undefined" != typeof module ? i(exports) : "function" == typeof define && define.amd ? define(["exports"], i) : i((a = "undefined" != typeof globalThis ? globalThis : a || self).ct = {});
})(this, function(a) {
	...
	function c(a, r) {
		const c = a.countries[r];
		if (!c) return null;
		const e = function(a) {
			return i ||= function(a) {
				return Object.keys(a.timezones).reduce((i, r) => {
					const c = a.timezones[r], { c: e, a: u } = c, n = a.timezones[u] || {}, o = e || n.c;
					if (!o) return i;
					for (const a of o) i[a] || Object.assign(i, { [a]: {
						current: [],
						all: []
	...
	function e(a) {
		const i = a % 60;
		return `${a < 0 ? "-" : "+"}${u(Math.floor(Math.abs(a) / 60))}:${u(i)}`;
	}
	function u(a) {
		const i = Math.abs(a);
		return `${i < 10 ? "0" : ""}${i}`;
	}
	var n = Object.keys(r.timezones).length, o = {}, A = {}, t = 0;
	function s(a = {}) {
		return Object.keys(r.countries).reduce((i, r) => Object.assign(i, { [r]: l(r, a) }), {});
	}
	function m(a = {}) {
		if (n !== t) for (const a of Object.keys(r.timezones)) d(a);
		return function(a, i) {
	...
	function d(a) {
		return A[a] || function(a) {
			if (!a) return;
			A[a.name] = a, t = Object.keys(a).length;
		}(function(a, i) {
			...
			const { a: c = null } = r, u = {
				...c ? a.timezones[c] : {},
				...a.timezones[i]
			}, n = u.c || [], o = u.u, A = Number.isInteger(u.d) ? u.d : o, t = {
				name: i,
				countries: n,
				utcOffset: o,
				utcOffsetStr: e(o),
	...
	function M(a, i = {}) {
		return ((d(a) || {}).countries || []).map((a) => l(a, i));
	}
	function S(a, i = {}) {
		const [r] = M(a, i);
		return r || null;
	...
	function E(a, i = {}) {
		const r = l(a, i);
		return r ? (r.timezones || []).map((a) => d(a)) : null;
	}
	a.default = {
		getCountry: l,
		getTimezone: d,
		getAllCountries: s,
		getAllTimezones: m,
		getTimezonesForCountry: E,
		getCountriesForTimezone: M,
		getCountryForTimezone: S
	}, a.getAllCountries = s, a.getAllTimezones = m, a.getCountriesForTimezone = M, a.getCountry = l, a.getCountryForTimezone = S, a.getTimezone = d, a.getTimezonesForCountry = E;
});
