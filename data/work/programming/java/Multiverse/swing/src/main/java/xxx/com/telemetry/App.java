...
//    .setTracerProvider(SdkTracerProvider.builder().addSpanProcessor(SimpleSpanProcessor.create(LoggingSpanExporter.create())).build())
//    .build();
//
...
//    .setTracerProvider(SdkTracerProvider.builder().addSpanProcessor(SimpleSpanProcessor.create(LoggingSpanExporter.create()))
...
//    openTelemetrySdk = OpenTelemetrySdk.builder().setTracerProvider(SdkTracerProvider.builder()
//    .addSpanProcessor(SimpleSpanProcessor.create(LoggingSpanExporter.create()))
//    .setSampler(Sampler.alwaysOff()).build())
//    .build();
//
//    printSpanLimits(openTelemetrySdk);
//
