// Build Hash Index V2
//
// Enhanced hash index that adds secondary matching signals (callees, strings, function signature) for functions that do not match by opcode hash alone. Includes confidence scoring.
//
// Usage: Run from Script Manager. Index saved to ~/ghidra_function_hash_index_v2.json.
 ...
 * - < 40: Do not match
 */
public class Propagate_BuildHashIndexV2 extends GhidraScript {
