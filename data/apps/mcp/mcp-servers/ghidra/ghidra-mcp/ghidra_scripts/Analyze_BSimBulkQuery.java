// BSim Bulk Query
//
// Queries all FUN_* functions against BSim to find matches from other ingested binaries. Returns a JSON summary with match results, similarity scores, and suggested names.
//
// Usage: Run from MCP or Script Manager. Args: [0]=BSim URL, [1]=max matches, [2]=similarity threshold, [3]=confidence, [4]=max functions.
...
public class Analyze_BSimBulkQuery extends GhidraScript {
