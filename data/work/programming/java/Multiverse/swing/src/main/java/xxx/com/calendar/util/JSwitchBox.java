...
public class JSwitchBox extends AbstractButton {
  ...
  private final Color light = new Color(220, 220, 220, 100);
  ...
  protected void paintComponent(Graphics g) {
    ...
    g2.setPaint(
        new GradientPaint(x, (int) (y - 0.1 * h), colorDark, x, (int) (y + 1.2 * h), light));
    g2.fillRect(x, y, w, h);
    g2.setPaint(
        new GradientPaint(x, (int) (y + .65 * h), light, x, (int) (y + 1.3 * h), colorDark));
