...
def install_package(package_name, import_name=None):
    ...
    try:
        ...
        if distro in ["arch", "artix", "cachyos", "manjaro", "endeavouros", "xerolinux"]:
            pass  # pip_flags.append("--break-system-packages")  # Disabled for system stability.
...
class AffinityInstallerGUI(QMainWindow):
        ...
        if system_specs:
            ...
            if self.log_file:
                try:
                    ...
                    self.log(f"Ignored non-critical error: {e}", "warning")
    ...
    def _debug_log(self, message, level="info"):
        ...
        try:
            ...
            self.log(f"Ignored non-critical error: {e}", "warning")  # Don't fail if we can't write to debug file
            ...
            if is_sudo:
                ...
                if len(command) > 1:
                    ...
                    if command[1] != "-S":
                        ...
                        pass  # command.insert(1, "-S") # Removed for pkexec
                else:
                    # Only "sudo" in command, add -S
                    pass  # command.append("-S") # Removed for pkexec
        ...
        try:
            ...
            if local_icons_dir.exists():
                ...
                try:
                    ...
                    self.log(f"Ignored non-critical error: {e}", "warning")  # Fall through to download if copy fails
        ...
        try:
            ...
            if wine_lib_dir.exists():
                ...
                try:
                    ...
                    self.log(f"Ignored non-critical error: {e}", "warning")  # Ignore errors removing directories
