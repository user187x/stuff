...
#<<<<<<< HEAD:data/work/kv4p-linux/walkie-talkie/src/main/java/xxx/Dashboard.java
#    private final JTextField freqField;
#    private final JButton setFreqBtn;
#    private final JButton scanBtn;
#||||||| parent of 32db6603 (Added bunch of busted shit for backup):data/work/kv4p-linux/walkie-talkie/src/main/java/xxx/Dashboard.java
#    private final JTextField freqField;
#    private final JButton setFreqBtn;
#=======
#>>>>>>> 32db6603 (Added bunch of busted shit for backup):data/work/kv4p-linux/walkie-talkie/src/main/java/xxx/beta/Dashboard.java
...
#=======
#    private final JComboBox<String> pcMicCombo, radioMicCombo, pcSpeakerCombo, radioSpeakerCombo;
#    private final JCheckBox pcMicEnable, radioMicEnable, pcSpeakerEnable, radioSpeakerEnable;
#
#>>>>>>> 32db6603 (Added bunch of busted shit for backup):data/work/kv4p-linux/walkie-talkie/src/main/java/xxx/beta/Dashboard.java
...
#=======
#        if (!radioMicEnable.isSelected() || !pcSpeakerEnable.isSelected()) {
#            log("Audio Warning: RX routing aborted because RX Mic or PC Speaker is manually disabled.");
#            return;
#        }
#
#        String radioMic = (String) radioMicCombo.getSelectedItem();
