...
public class RadioServiceConnector {
    ...
    private final List<Consumer<com.vagell.kv4pht.radio.RadioAudioService>> callbacks = new ArrayList<>();
    ...
    private final ServiceConnection connection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder binder) {
            com.vagell.kv4pht.radio.RadioAudioService.RadioBinder radioBinder = (RadioAudioService.RadioBinder) binder;
